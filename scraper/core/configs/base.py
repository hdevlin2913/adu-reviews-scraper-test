...
class Settings(BaseSettings):
    ...
    redis_settings: RedisSettings = Field(default_factory=RedisSettings, validation_alias="redis")
    nats_settings: NatsSettings = Field(default_factory=NatsSettings, validation_alias="nats")
    storage_settings: StorageSettings = Field(default_factory=StorageSettings, validation_alias="storage")
